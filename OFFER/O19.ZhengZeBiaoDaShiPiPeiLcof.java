...
// 
// Related Topics 递归 字符串 动态规划 👍 344 👎 0
...
public class ZhengZeBiaoDaShiPiPeiLcof {
    ...
    class Solution {
        ...
        private boolean match(String s, String p,int sLoc,int pLoc){
            if(sLoc==0) return false;
            if(p.charAt(pLoc-1)=='.') return true;
            return s.charAt(sLoc-1)==p.charAt(pLoc-1);
        }
    }
